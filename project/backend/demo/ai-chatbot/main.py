...
def initialize_gemini_environment():
    ...
    print("Environment successfully initialized for Gemini!")
    print(f"Loaded Google API Key: {masked_key}")
    print("LangGraph and python-dotenv are ready. Next step: Configure the Guardrails Agent.")

if __name__ == "__main__":
    initialize_gemini_environment()